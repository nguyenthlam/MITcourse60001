...
if __name__ == '__main__':
    ...
    message = SubMessage('I am feeling happy. Done homework')
    permutation = 'ioeau'
    e_dict = message.build_transpose_dict(permutation)
    e_mess = EncryptedSubMessage(message.apply_transpose(e_dict))
    print("Decrypted message:", e_mess.decrypt_message())
